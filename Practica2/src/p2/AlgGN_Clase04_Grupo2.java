...
public class AlgGN_Clase04_Grupo2 {
	...
	/**
	 * Obtiene soluci�n al problema mediante un algoritmo gen�tico. Muestra la poblaci�n final por salida est�ndar
	 * @param data Datos del problema
	 * @param param Par�metros de la ejecuci�n
	 * @param log Objeto Logger para los archivos de registro
	 * @return Mejor individuo de la poblaci�n final
	 * @throws IOException
	 */
	...
	/**
	 * Torneo Binario para la selecci�n de pares de individuos
	 * @param poblacion Poblaci�n actual de la que seleccionar
	 * @param param Par�metros de la ejecuci�n
	 ...
	 * @param elegidos Selecci�n de individuos
	 * @param param Par�metros de la ejecuci�n
	...
	private static void repararMPX(ArrayList<Integer> individuo, ArrayList<Integer> candidatos) {
		...
		} else { //Si tiene m�s alelos, se quitan los de menos aporte
	...
	/**
	 * Operador de mutaci�n. Muta alelos de los hijos aleatoriamente
	 * @param elegidos Colecci�n de hijos
	 * @param param Par�metros de la ejecuci�n
	 */
	...
	/**
	 * Calcula el coste de la selecci�n
	 * @param elegidos Colecci�n de hijos
	 */
	...
	/**
	 * Reemplaza la poblaci�n con los hijos generados, manteniendo la �lite anterior
	 * @param padres Colecci�n de padres
	 * @param hijos Colecci�n de hijos
	 * @param param Par�metros de la ejecuci�n
	 * @return Nueva poblaci�n de hijos
	 */
